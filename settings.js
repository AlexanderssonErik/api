let settings = {
    ...
    init: function () {
        ...
        startButton.addChild(new GuiButtonImg("./icon/settings/hideBlocks.svg"), guiOptions.childRight)
      ...
      //  button.addChild(new GuiButtonImg("./icon/settings/soundOff.svg", function(){ display })), guiOptions.childRight);
