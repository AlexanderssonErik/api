let tangramLevel = {
  buildLevel: function (level) {
    ...
    // 1
    level.push({ difficulty: [], image: "./icon/games/tangram/lvl1.svg"  });
    ...
    //2
    level.push({ difficulty: [], image: "./icon/games/tangram/lvl2.svg" });
    ...
    //3
    level.push({ difficulty: [], image: "./icon/games/tangram/lvl3.svg"  });
    ...
    //4
    level.push({ difficulty: [], image: "./icon/games/tangram/lvl4.svg" });
    ...
    //5
    level.push({ difficulty: [], image: "./icon/games/tangram/lvl5.svg" });
